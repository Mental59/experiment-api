...
def run(
    ...
    **kwargs
    ...
    with get_experiment_tracker(experiment_tracker_type, project, run_name, **kwargs) as experiment_tracker:
        ...
        experiment_tracker.log_params(TRAIN_PARAMETERS_SAVE_KEY, train_run_params)
        experiment_tracker.add_tags(dict(model_name=train_run_params['model_name'], mode='test', run_name=run_name))
